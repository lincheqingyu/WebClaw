...
| 运行时 | 51 | 管理会话生命周期、权限审批、上下文压缩、replay prompt frame 和确认流 | [会话运行时](../../backend/src/runtime/session-runtime-service.ts)、[权限中心](../../backend/src/runtime/permissions/manager.ts)、[Prompt Frame](../../backend/src/runtime/context/prompt-frame-builder.ts) |
| 记忆系统 | 18 | 记忆提取、去重、写入、召回、压缩与提示词注入 | [记忆协调](../../backend/src/memory/coordinator.ts)、[记忆注入](../../backend/src/memory/prompt-injector.ts)、[SQLite 存储](../../backend/src/memory/sqlite-store.ts) |
...
<details>
<summary>展开完整文件清单：169 个后端代码文件的路径、职责和调用链（主要给 Codex / Claude Code 精确定位）</summary>
